    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <Card className="border-brand-secondary/15">
            <CardHeader>
              <CardTitle className="text-2xl text-text" style={{ color: '#044078' }}>Send us a message</CardTitle>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="name" className="text-text" style={{ color: '#044078' }}>
                      Name *
                    </Label>
                    <Input
                      id="name"
                      ...
                      className="border-brand-secondary/20 focus:border-brand-primary"
                      placeholder="Your full name"
                    />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="email" className="text-text" style={{ color: '#044078' }}>
                      Work Email *
                    </Label>
                    <Input
                      id="email"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="company" className="text-text" style={{ color: '#044078' }}>
                      Company
                    </Label>
                    <Input
                      id="company"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="phone" className="text-text" style={{ color: '#044078' }}>
                      Phone
                    </Label>
                    <Input
                      id="phone"
                ...
                <div className="space-y-2">
                  <Label htmlFor="message" className="text-text" style={{ color: '#044078' }}>
                    Message *
                  </Label>
                  <Textarea
                    id="message"
        ...
        >
          <div className="space-y-6">
            <h3 className="text-2xl font-bold text-text" style={{ color: '#044078' }}>Other ways to reach us</h3>
          ...
          <div className="bg-gradient-to-br from-brand-primary/10 to-brand-secondary/10 rounded-2xl p-8">
            <h4 className="text-xl font-bold text-text mb-4" style={{ color: '#044078' }}>Why choose us?</h4>
            <ul className="space-y-3 text-brand-secondary">
              <li className="flex items-start space-x-3">
                <div className="w-2 h-2 bg-brand-primary rounded-full mt-2 flex-shrink-0" />
                <span style={{ color: '#044078' }}>Free consultation and project assessment</span>
              </li>
              <li className="flex items-start space-x-3">
                <div className="w-2 h-2 bg-brand-primary rounded-full mt-2 flex-shrink-0" />
                <span style={{ color: '#044078' }}>Flexible engagement models</span>
              </li>
              <li className="flex items-start space-x-3">
                <div className="w-2 h-2 bg-brand-primary rounded-full mt-2 flex-shrink-0" />
                <span style={{ color: '#044078' }}>Dedicated project manager</span>
              </li>
              <li className="flex items-start space-x-3">
                <div className="w-2 h-2 bg-brand-primary rounded-full mt-2 flex-shrink-0" />
