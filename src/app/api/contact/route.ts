...
export async function POST(request: NextRequest) {
  try {
    ...
    const recipientEmail = process.env.CONTACT_EMAIL || 'info@ampliedtech.com';
    const fromEmail = process.env.FROM_EMAIL || 'noreply@ampliedtech.com';
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="margin-top: 20px; padding: 15px; background-color: #e3f2fd; border-radius: 8px; border-left: 4px solid #044078;">
            <p style="margin: 0; color: #666; font-size: 14px;">
              This message was sent from the Amplied Technology website contact form.
            </p>
          </div>
        </div>
      `,
