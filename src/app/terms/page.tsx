        ...
        <Section background="surface">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none space-y-8">
              ...
              <div className="bg-white rounded-2xl border border-brand-secondary/15 p-8 space-y-6">
                <h2 className="text-2xl font-bold text-text">3. Service Agreement</h2>
                <div className="space-y-4 text-brand-secondary">
              ...
              <div className="bg-white rounded-2xl border border-brand-secondary/15 p-8 space-y-6">
                <h2 className="text-2xl font-bold text-text">4. Client Responsibilities</h2>
                <div className="space-y-4 text-brand-secondary">
              ...
              <div className="bg-white rounded-2xl border border-brand-secondary/15 p-8 space-y-6">
                <h2 className="text-2xl font-bold text-text">5. Payment Terms</h2>
                <div className="space-y-4 text-brand-secondary">
              ...
              <div className="bg-white rounded-2xl border border-brand-secondary/15 p-8 space-y-6">
                <h2 className="text-2xl font-bold text-text">6. Intellectual Property</h2>
                <div className="space-y-4 text-brand-secondary">
              ...
              <div className="bg-white rounded-2xl border border-brand-secondary/15 p-8 space-y-6">
                <h2 className="text-2xl font-bold text-text">7. Confidentiality</h2>
                <div className="space-y-4 text-brand-secondary">
              ...
              <div className="bg-white rounded-2xl border border-brand-secondary/15 p-8 space-y-6">
                <h2 className="text-2xl font-bold text-text">9. Service Availability</h2>
                <div className="space-y-4 text-brand-secondary">
              ...
              <div className="bg-white rounded-2xl border border-brand-secondary/15 p-8 space-y-6">
                <h2 className="text-2xl font-bold text-text">10. Termination</h2>
                <div className="space-y-4 text-brand-secondary">
              ...
              <div className="bg-white rounded-2xl border border-brand-secondary/15 p-8 space-y-6">
                <h2 className="text-2xl font-bold text-text">11. Governing Law</h2>
                <div className="space-y-4 text-brand-secondary">
              ...
              <div className="bg-white rounded-2xl border border-brand-secondary/15 p-8 space-y-6">
                <h2 className="text-2xl font-bold text-text">12. Changes to Terms</h2>
                <div className="space-y-4 text-brand-secondary">
              ...
              <div className="bg-white rounded-2xl border border-brand-secondary/15 p-8 space-y-6">
                <h2 className="text-2xl font-bold text-text">13. Contact Information</h2>
                <div className="space-y-4 text-brand-secondary">
